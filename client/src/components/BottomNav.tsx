    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 pb-safe">
      <div className="relative h-16 bg-slate-900/95 backdrop-blur-sm border-t border-slate-700">
        <div className="flex items-center justify-around h-full px-4 relative">
          ...
          >
            <Waves className={`w-6 h-6 ${isActive('/redirect') ? 'drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]' : ''}`} />
          ...
          >
            <User className={`w-6 h-6 ${isActive('/profile') ? 'drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]' : ''}`} />
